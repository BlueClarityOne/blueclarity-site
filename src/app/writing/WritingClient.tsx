  ...
  return (
    <main className="min-h-screen text-white relative z-10 flex flex-col">
      ...
      <div className="flex-1 px-8 py-16 max-w-3xl">
        <div className="mb-4">
          <span className="text-sm font-mono tracking-widest uppercase" style={{ color: colors.primary }}>Thoughts</span>
        </div>
              ...
              >
                <Link href={`/writing/${post.slug}`} className="group">
                  <div className="flex items-baseline justify-between mb-2">
                    <h2 className="text-xl font-medium group-hover:opacity-80 transition-opacity">
                      {post.title}
                    </h2>
